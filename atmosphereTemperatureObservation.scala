...
package com.media.spark.sparkdemo
...
object atmosphereTemperatureObservation {
  ...
  .master("local")
  .appName("Atmosphere Temperature Extraction")
...
val startTime = System.currentTimeMillis()
    ...
    logger.info("downloading data from link and creating rdd from the text file")
...
This is done because code was failing during data type conversion*/
    ...
    logger.info("creating final data with data type conversion")
